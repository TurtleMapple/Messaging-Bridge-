# Coding Standard - Hono Messaging Bridge

Dokumen ini mendefinisikan standar pengkodean, prinsip desain, dan praktik terbaik yang harus diikuti dalam pengembangan proyek **Hono Messaging Bridge**. Tujuannya adalah untuk memastikan kode yang dihasilkan konsisten, mudah dipelihara (maintainable), dan memiliki kualitas tinggi.
