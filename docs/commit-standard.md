...
Dokumen ini mendefinisikan standar penulisan pesan commit yang harus diikuti dalam proyek **Hono Messaging Bridge**. Kita menggunakan spesifikasi **Conventional Commits** untuk memastikan riwayat commit yang bersih, terstruktur, dan mudah dibaca secara otomatis.
